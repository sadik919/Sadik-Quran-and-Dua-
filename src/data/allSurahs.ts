...
export const allSurahs: QuranSurah[] = [
  ...
  { number: 6, name: "الأنعام", englishName: "Al-Anjam", englishNameTranslation: "The Cattle", numberOfAyahs: 165, revelationType: "Meccan" },
  ...
  { number: 69, name: "الحاقة", englishName: "Al-Haqqah", englishNameTranslation: "The Inevitable Hour", numberOfAyahs: 52, revelationType: "Meccan" },
